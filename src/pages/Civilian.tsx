    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          My Complaints
          <Badge variant="secondary">{complaints.length} total</Badge>
        </CardTitle>
      </CardHeader>
      <CardContent>
        {complaints.length === 0 ? (
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                        <div className="flex items-center space-x-1">
                          ...
                          <span>Case #{complaint.caseNumber}</span>
                        </div>
                        <div className="flex items-center space-x-1">
                          <MapPin className="h-3 w-3" />
                          <span className="truncate max-w-32">{complaint.location.address}</span>
                        </div>
                        <span>
                      ...
                      {complaint.assignedOfficer && (
                        <div className="mt-2 text-xs text-muted-foreground">
                          Assigned to: {complaint.assignedOfficer.name} (Badge #{complaint.assignedOfficer.badgeNumber})
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => window.open(`/track/${complaint.caseNumber}`, '_blank')}
                      >
